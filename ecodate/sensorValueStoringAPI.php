<?php
require_once '../model/InsertDeviceSensorsValue.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
	...
	$pm10 = $_GET['s7'];
	$noise = $_GET['s8'];
	$device_serial_no=$_GET['mid'];
	date_default_timezone_set('Asia/Kolkata');
	$currentDateTime = date("Y-m-d H:i:s");
	$time=$currentDateTime;
    $fetchSensorDetails = new InsertDeviceSensorsValue();
    $response['addDeviceDetailsResponse'] = $fetchSensorDetails -> insertValuesOfSensorAsPerRoomno($dust, $co2, $no2, $humidity, $co, $tempreture, $pm10,$noise,$device_serial_no,$time);
