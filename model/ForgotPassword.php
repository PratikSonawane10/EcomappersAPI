<?php
require_once '../dao/ForgotPasswordDAO.php';
...
//for login
  /*  public function CheckingUsersDetails($email,$password) {
        ...
        $showLoginDetailsDAO = new ForgotPasswordDAO();
    ...
    public function SettingNewPassword($activationCode,$newPassword,$email) {
        ...
        $this->setEmail($email);
        $newPasswordDetailsDAO = new ForgotPasswordDAO();
 ...
 //checkin mail valid user or not..
    public function CheckingEmail($email) {
     ...
     public function GenarateRandomNo($email) {
        ...
        //call ForgotPasswordDAO to save random no as per user 
        $saveRandomNoDAO= new ForgotPasswordDAO();
