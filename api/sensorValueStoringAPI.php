...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $response['addDeviceDetailsResponse'] = $fetchSensorDetails -> insertValuesOfSensorAsPerRoomno($pm2, $co2, $no2, $humidity, $co, $tempreture, $pm10,$noise,$device_serial_no,$time);
